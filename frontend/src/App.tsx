...
import CarTelegramPage from './pages/CarTelegramPage';
        ...
        <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
          <ErrorBoundary>
            <Routes>
              ...
              <Route path="/car-telegram" element={<ProtectedRoute><ErrorBoundary><CarTelegramPage /></ErrorBoundary></ProtectedRoute>} />
            </Routes>
          </ErrorBoundary>
        </main>
      </div>
